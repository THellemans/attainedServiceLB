...
legend_loc="west"; xLab='$\lambda$'; yLab='$E_{W, rel, SQ(d)-RTB-RE(2)}$'; xLim=[0.3,1]; yLim=[-0.01, 1];
...
x=lambdas; y=EW_rel; legend_entries={"$d=2$",  "$d=5$",  "$d=10$",  "$d=15$",  "$d=20$"};
legend_loc="northeast"; xLab='$\lambda$'; yLab='$E_{W, rel, RE(d,2)}$'; xLim=[0.3,1]; yLim=[0, 1];
